								...
								<div class="dataTables_length">
									<form action="student" method="get" class="form-horizontal row-fluid">
										<div class="control-group" style="height:35px;">
											...
											<input class="span3" style="float:left;" type="text" name="stuName" value="${requestScope.stuName}" placeholder="填写姓名"/>
											<label class="control-label"  style="width:65px;"><span class="red">*</span>学号：</label>
											<input class="span3" style="float:left;" type="text" name="stuNo" value="${requestScope.stuNo}" placeholder="填写学号"/>
